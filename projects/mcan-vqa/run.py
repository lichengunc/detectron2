...
def parse_args():
    ...
    parser.add_argument('--IMG_FEAT_SIZE', dest="IMG_FEAT_SIZE",
                      default=2048,
...
if __name__ == '__main__':
    ...
    # additional configs for adapting Detectron2 features
    if args.FEATURE_PATH:
        __C.FEATURE_PATH = args.FEATURE_PATH
        __C.IMG_FEAT_PATH = {
            'train': __C.FEATURE_PATH + 'train2014/features/',
            'val': __C.FEATURE_PATH + 'val2014/features/',
            'test': './datasets/coco_extract/test2015'}
    __C.IMG_FEAT_SIZE = args.IMG_FEAT_SIZE
